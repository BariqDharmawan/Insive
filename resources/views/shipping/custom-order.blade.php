  ...
  <main>
    <div class="container">
      <div class="row">
        ...
        <div class="col">
          <p class="bg--cream mt-3 mb-5 py-1 px-2 d-lg-inline-block">
          ...
          <form action="{{route('home.shipping.store')}}" method="post">
              ...
              <div class="form-group form-row">
                  ...
                  <div class="col-12 col-lg-10">
                      ...
                      name="customer_email" placeholder="Please Fill Your Email"
              ...
              <div class="form-group form-row">
                  ...
                  <div class="col-12 col-lg-10">
                      ...
                      name="customer_phone" @auth value="{{ Auth::user()->phone }}"
                      @endauth placeholder="Please Fill With Your Active Number" required>
                  </div>
              </div>
              <div class="form-group form-row">
              ...
              <div class="form-group form-row">
                  ...
                  <div class="col-12 col-lg-10">
                    <textarea class="form-control" name="customer_address" id="address" rows="8"
                    placeholder="Please Fill Your Address" required>@auth{{ Auth::user()->address }}@endauth</textarea>
                  </div>
              </div>
              <button type="submit" class="btn bg--cream float-right mt-3">
                  Go to payment​ <i class='bx bx-money ml-2'></i>
              </button>
          </form>
        </div>
      </div>
