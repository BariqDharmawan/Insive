    ...
    <div class="container py-5">
      <figure class="product-selected">
        <div class="row">
          ...
          <figcaption class="col-md-8 py-3 row justify-content-between align-content-between mx-0">
            <p class="font-weight-bold mb-4 text-center text-md-left w-100">Formula Code: <var class="d-block font-weight-bolder">#02139</var></p>
