                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-center">
                      <form action="{{ route('admin.product.permanently_delete.single', $product->id) }}" method="post">
                        @csrf @method('DELETE')
                        <button type="submit" class="btn btn-danger w-100">Yapp, remove it permanent</button>
                      </form>
                    </div>
                  </div>
                </div>
        ...
        <tfoot>
          <tr>
            <td class="mx-auto text-center" colspan="7">
              <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#modal-delete-permanent">
              ...
              <div class="modal fade" id="modal-delete-permanent">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-center">
                      <form action="{{ route('admin.product.permanently_delete.all', $product->id) }}" method="post">
                        @csrf @method('DELETE')
                        <button type="submit" class="btn btn-danger w-100">Yapp, remove it permanent</button>
                      </form>
                    </div>
