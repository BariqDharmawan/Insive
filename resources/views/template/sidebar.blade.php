<div class="sidebar mySimpleBar" data-simplebar data-simplebar-auto-hide="true">
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.sheet.index') }}"
                    class="nav-link {{ (Request::is('admin/sheet'))? 'active' : '' }}">
                    <i class="nav-icon far fa-newspaper"></i>
                    <p>Sheet</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('admin.fragrance.index') }}"
                    class="nav-link {{ (Request::is('admin/fragrance'))? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.pricing.index') }}"
                    class="nav-link {{ (Request::is('admin/pricing'))? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.logic.index') }}"
                    class="nav-link {{ (Request::is('admin/logic'))? 'active' : '' }}">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.product.trashed') }}"
                            class="nav-link {{ (Request::is('admin/product/trash')) ? 'active' : '' }}">
